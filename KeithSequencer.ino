...
GenericFP StateFuncs[] = {AllOff, //keith
                          PowerUp, // 1 both power on
                          AllOff, // 2 keith off ships & motorcycles
                          AllOn, // 3 keith on
                          AllOff, // 4 Keith off, carry and drop
                          AllOn, // 5 Keith On
                          AllOn,// 6 grace off, keith on solo
                          AllOff, // 7 keith off, grace on solo
                          AllOn, // 8 keith on
                          AllOff, // 9 keith off, grace back bend
                          AllOn, // 10 keith on
